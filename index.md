...
This notebook provides a very [simple example of Bayesian parameter estimation](https://github.com/alreich/ipython-notebooks/blob/master/Bayesian_Beta_Binomial_Example.ipynb) using the Beta-Binomial model. Both analytical and simulation-based results are presented.  Three different approaches are used to obtain a parameter estimate for this model:
